...
class bg {
    constructor(){
        ...
        this.image.src = 'assets/Sampleimage.png';
        this.x=0;
        this.y=0; 
        this.height=705;
        this.width=1600;
...
constructor(position){
        ...
        if (!chara) {
            ...
            this.image.src = "assets/Dude_Monster_Idle_4.png"; 
        }
        switch(chara){
            case '1':
            this.image.src="assets/Dude_Monster_Idle_4.png";
            break;
            case '2':
            this.image.src="assets/Owlet_Monster_Idle_4.png";
            break;
            case '3':
            this.image.src="assets/Pink_Monster_Idle_4.png";
            break;
            default:
...
class Enemy {
    constructor(position){
        this.image=new Image();
        this.image.src='assets/Black_crystal1.png';
        this.width = 75;
        this.height = 60;
        this.position=position;
